    ...
    <div className="min-h-screen bg-black p-6 space-y-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">Plan & Shoot New Video</h1>
        ...
        <WorkspaceSection
          ...
          onStoryboardFilesChange={(files) => updateFormData('storyboardFiles', files)}
        />

        {/* Shot Logging Section */}
        <ShotLoggingSection
          scenes={formData.scenes}
          onChange={(scenes) => updateFormData('scenes', scenes)}
        />

        {/* Team Assignment Section */}
        <TeamAssignmentSection
          teamAssignments={formData.teamAssignments}
          onChange={(assignments) => updateFormData('teamAssignments', assignments)}
        />
      </div>
    </div>
  );
