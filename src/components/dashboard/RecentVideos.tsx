      ...
      <div className="space-y-4">
        {mockVideos.map((video, index) => (
          <motion.div
            ...
            className="flex items-center space-x-4 p-3 rounded-lg hover:bg-gray-700 transition-colors cursor-pointer"
          >
            {/* Thumbnail - Made larger */}
            <img
              src={video.thumbnail}
              alt={video.title}
              className="w-24 h-16 bg-gray-600 rounded object-cover flex-shrink-0"
            />
