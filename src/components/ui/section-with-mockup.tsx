...
const SectionWithMockup: React.FC<SectionWithMockupProps> = ({
    ...
    const layoutClasses = reverseLayout
        ? "md:grid-cols-[30%_70%] md:grid-flow-col-dense"
        : "md:grid-cols-[30%_70%]";
            ...
            <div className="container w-full px-4 md:px-6 relative z-10 mx-auto">
                ...
                >
                    ...
                    >
                        ...
                        <motion.div
                             className={`absolute w-[85%] h-[75vh] md:h-[85vh] bg-[#090909] rounded-[32px] z-0`}
                             style={{
                        ...
                        >
                            <div
                                className="relative w-full h-full bg-cover bg-center bg-no-repeat rounded-[32px]"
                                style={{
                        ...
                        {/* Main Mockup Card */}
                        <motion.div
                            className="relative w-full h-[70vh] md:h-[90vh] bg-[#ffffff0a] rounded-[32px] backdrop-blur-[15px] backdrop-brightness-[100%] border-0 z-10 overflow-hidden"
                            initial={{ y: reverseLayout ? 0 : 0 }}
                            whileInView={{ y: reverseLayout ? 20 : 30 }}
