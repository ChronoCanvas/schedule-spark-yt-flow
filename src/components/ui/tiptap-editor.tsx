      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center space-x-2 flex-wrap">
          ...
          <button
            ...
            className="flex items-center space-x-1 px-3 py-1 rounded text-sm bg-gray-700 hover:bg-gray-600 text-white transition-colors"
        ...
        <div className="text-xs text-gray-500">
          <p>Shortcuts: Ctrl+B (bold), Ctrl+I (italic), Ctrl+U (underline), Ctrl+Shift+S (strike), Ctrl+H (highlight), Ctrl+K (link)</p>
        </div>
      </div>
    </>
  );
